...
const caseStudies = [
  ...
  },
  {
    ...
    outcome:
      "structured operations, scalable brand, consistent customer experience",
  ...
  },
  {
    ...
    outcome:
      "repeatable operations, diversified revenue, scalable creative platform",
...
export function Work() {
  return (
    <section id="work" className="py-24 px-6 md:px-12 lg:px-24 bg-secondary">
          ...
          {caseStudies.map((study, index) => (
            ...
            >
              <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                ...
                <div className="mb-6">
                  <p className="font-medium mb-2">Broccoli Studios scope:</p>
